// MODDESS TIPS - VIP Côte 2 Category (With Back Button and Auto-Refresh)
...
export default function VipCote2Screen() {
  ...
  const loadPredictions = async () => {
    const { data, error } = await predictionsService.getPredictionsBySection('cote_2_vip');
    if (error) {
    ...
    <View style={[styles.container, { paddingTop: insets.top }]}>
      ...
      <View style={styles.header}>
        ...
        <View style={styles.headerContent}>
          <Text style={styles.title}>Odds 2 - VIP</Text>
          <Text style={styles.subtitle}>Professional analysis ~2.00</Text>
        </View>
